<template>
  <div ref="table" :id="id" class="advanced-table" :style="{ 'min-height': minHeight }">
    <a-spin :spinning="loading">
      <div :class="['header-bar', size]">
        ...
        <div class="topSet" v-if="setingFlag === 'top' && isShowSetBtn">
        ...
        <div v-if="setingFlag === 'table'">
          <transition name="slide-fade">
            <div
              ...
              :style="{
                background: sSize === 'small' ? '#fff' : '#fafafa',
                top: settingTop,
...
export default {
  ...
  props: {
    ...
    needTitle: { type: Boolean, default: true },
  },
  provide() {
    return {
      table: this,
