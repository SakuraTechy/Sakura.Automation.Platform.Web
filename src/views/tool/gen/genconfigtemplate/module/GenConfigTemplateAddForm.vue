      ...
      <a-row :gutter="32">
        ...
        <a-col :span="12">
          <a-form-model-item label="后端工作空间" prop="workspacePath">
            <a-input v-model="form.workspacePath" placeholder="示例：C:\cloud-platform\Sakura-Vue\ruoyi-system" />
          </a-form-model-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="12">
          <a-form-model-item label="包路径" prop="packageName">
            <a-input v-model="form.packageName" placeholder="示例：com.sakura.system" />
          </a-form-model-item>
        </a-col>
        <a-col :span="12">
