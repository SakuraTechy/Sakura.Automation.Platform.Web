...
import { timedTaskTypeOptions, timedTaskStatusOptions, timedTaskRunEnvironmentOptions } from './Config'
    ...
    async application() {
      ...
      const applicationsFormData = new FormData();
        [
          ...
          ['authorizationDeadlineTime', this.$config[abbreviate].authorizationDeadlineTime],
          ['maintenanceWarnDate', this.$config[abbreviate].maintenanceWarnDate],
