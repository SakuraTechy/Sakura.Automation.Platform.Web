<template>
  <a-spin :spinning="loading" tip="加载中...">
    <div class="container">
      <keep-alive>
        <iframe :src="runnergo" frameborder="no" style="width: 100%; height: 100%" scrolling="auto" sandbox="allow-same-origin allow-top-navigation allow-forms allow-scripts allow-popups"/>
      </keep-alive>
    </div>
  </a-spin>
</template>
