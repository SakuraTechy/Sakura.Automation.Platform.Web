          ...
          <a-row :gutter="[16, 16]" class="top-list">
            <a-col :xxl="6" :xl="8" :lg="16" style="height: 164px">
              <a
                ...
                href="https://gitee.com/big-hedgehog/aidex-sharp"
                target="_blank"
                v-if="bannerType === '1'"
                ><img src="@/views/dashboard/images/banner3.png"
              /></a>
              <a
                style="display: block; height: 148px; overflow: hidden; border-radius: 4px; background: #516bf7"
                href="https://gitee.com/big-hedgehog/aidex-sharp"
  ...
  data() {
    return {
      ...
      dataList: [
        ...
        {
          path: 'projectSetting/project',
          icon: 'windows',
          title: '项目管理',
        },
        {
          path: 'projectSetting/environment',
          icon: 'windows',
          title: '环境管理',
        },
        {
          path: 'projectSetting/version',
          icon: 'windows',
          title: '版本管理',
        },
        {
