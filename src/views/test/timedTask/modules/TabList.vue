<template>
  <div class="tab-content">
    ...
    <a-tabs v-model="activeKey" hideAdd type="editable-card" @edit="onEdit">
      <a-tab-pane key="0" :tab="fixedTab" :closable="false">
        <!-- <slot name="功能测试场景"></slot> -->
      </a-tab-pane>
      <a-tab-pane key="1" :tab="tab" :closable="false">
        <slot :name="tab"></slot>
      </a-tab-pane>
...
export default {
  ...
  mounted() {
    ...
    if(this.tab==='场景列表'){
      ...
      tabs1[2]?tabs1[2].style.left = '5px':''
      tabs1[2]?tabs1[2].style.maxWidth = 'calc(100% - 82px)':''
    }
  },
  methods: {
    // 关闭tab
