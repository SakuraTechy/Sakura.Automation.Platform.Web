      ...
      <a-row :gutter="48">
        ...
        <a-col :md="8" :sm="24">
          <a-form-item label="版本号">
            <a-select v-model="searchParam.versionId" placeholder="请选择" style="width: 160px">
        ...
        <a-col :md="8" :sm="24" v-if="advanced">
          <a-form-item label="用例等级">
            <a-select v-model="searchParam.estate" placeholder="请选择" style="width: 160px">
        ...
        <a-col :md="8" :sm="24">
          <a-form-item label="用例状态" v-if="advanced">
            <a-select v-model="searchParam.status" placeholder="请选择" style="width: 160px">
